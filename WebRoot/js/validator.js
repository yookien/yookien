...
Validator = {
	...
	validate : function(theForm,xmlFile,mode){
		...
		xmlFile = (xmlFile == null) ? "/js/validator/validation.xml" : "/js/validator/validation_"+xmlFile+".xml";
		...
		// alert("xPath = " + xPath + "xmlFile = " + xmlFile);
	...
	getValue : function(fieldname){
		return this.getObject(fieldname).value;
	},
